document.addEventListener("DOMContentLoaded", function () {
    ...
    const links = document.querySelectorAll('.nav-link'); // Ajout du point pour indiquer une classe
    const icons = document.querySelectorAll('.iconify'); // Ajout du point pour indiquer une classe
    ...
    function scrollToSection(index) {
        ...
        animateScroll(document.documentElement, targetScrollTop, 800, function () {
